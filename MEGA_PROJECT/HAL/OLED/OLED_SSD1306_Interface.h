/*
 * OLED_SSD1306_Interface.h
 *
 *  Created on: Mar 12, 2023
 *      Author: dell
 */

#ifndef HAL_OLED_SSD1306_OLED_SSD1306_INTERFACE_H_
#define HAL_OLED_SSD1306_OLED_SSD1306_INTERFACE_H_
...
void OLED_DisplayString(uint8 *);
void OLED_ScrollMessage(uint8 lineNum, char *strptr);
...
void OLED_VerticalGraph(uint8 var_barGraphNumber_u8, uint8 var_percentageValue_u8);
void OLED_HorizontalGraph(uint8 var_barGraphNumber_u8, uint8 var_percentageValue_u8);
/**************************************************************************************************/

#endif /* HAL_OLED_SSD1306_OLED_SSD1306_INTERFACE_H_ */
